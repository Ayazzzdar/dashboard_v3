...
def render_page1(order, output_path):
    ...
    # long numbers fill the width). Capped 170, floored 60.
    _sal_max_w = (725 - 188) - 52
    ...
    while _sal_size > 60:
        ...
        if (_pb[2] - _pb[0]) <= _sal_max_w and (_pb[3] - _pb[1]) + 14 + _py_probe_h <= _sal_max_h:
            break
        _sal_size -= 2
    sal_amount_f = LB(_sal_size, "Bold")
